...
public class JavaMailApi_Salles extends AsyncTask<Void,Void,Void> {
    ...
    //Constructor
    public JavaMailApi_Salles(Context mContext, String mEmail, String mSubject, String mMessage) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            mm.setFrom(new InternetAddress(SallesFragment.MY_EMAIL));
